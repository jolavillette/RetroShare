...
#define COLUMN_SESSION_IN 3
#define COLUMN_IN_MAX 4
#define COLUMN_IN_ALLOWED 5
#define COLUMN_IN_QUEUE_ITEMS 6
#define COLUMN_OUT_RATE 7
#define COLUMN_SESSION_OUT 8
#define COLUMN_OUT_MAX 9
#define COLUMN_OUT_ALLOWED 10
#define COLUMN_OUT_QUEUE_ITEMS 11
#define COLUMN_OUT_QUEUE_BYTES 12
#define COLUMN_DRAIN 13
